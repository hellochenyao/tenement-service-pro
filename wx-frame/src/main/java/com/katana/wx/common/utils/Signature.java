...
import com.katana.wx.pay.utils.Configure;
import com.katana.wx.pay.utils.XMLParser;
...
public class Signature {
    ...
    public static String getSignForObject(Object o, String Apikey) {
        ...
        System.out.println("params sign before:" + result);
        String Signresult = EncryptUtils.EncryptMD5(result).toUpperCase();
        System.out.println("params sign result:" + Signresult);
        return Signresult;
    }
